...
class _ImageCardState extends State<ImageCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap: () async{
        await FirestoreMethods().viewPost(widget.snap['postId'], user.uid, widget.snap['views']);
                ...
                ClipRRect(
                  ...
                  child: Hero(
                    tag: widget.snap['postUrl'],
                      child: CachedNetworkImage(imageUrl:widget.snap['postUrl'], fit: BoxFit.cover)),
                ),
                AnimatedOpacity(
              ...
              Container(
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 3),
                      Container(child: Text(NumberFormat.compact().format(widget.snap['likes'].length).toLowerCase(),),),
                      SizedBox(width: 5,),
                      ],
                  )
